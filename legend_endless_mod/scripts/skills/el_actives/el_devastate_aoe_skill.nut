this.el_devastate_aoe_skill <- this.inherit("scripts/skills/skill", {
	m = {
		TilesUsed = []
	},
	function create()
	{
		...
		this.m.Icon = "el_skills/devastate_aoe_skill.png";
		this.m.IconDisabled = "el_skills/devastate_aoe_skill_sw.png";
