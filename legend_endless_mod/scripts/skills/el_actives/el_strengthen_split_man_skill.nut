this.el_strengthen_split_man_skill <- this.inherit("scripts/skills/skill", {
	m = {
	...
	function create()
	{
		...
		this.m.IconDisabled = "el_skills/strengthen_split_man_skill_sw.png";
	...
	function onAnySkillUsed( _skill, _targetEntity, _properties )
	{
		if (_skill == this)
		{
			_properties.DamageTooltipMinMult *= 2;
			_properties.DamageTooltipMaxMult *= 2;
		}
	}
