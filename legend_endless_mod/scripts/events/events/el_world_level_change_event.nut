this.el_world_level_change_event <- this.inherit("scripts/events/event", {
	...
	function onPrepare()
	{
		...
		local select_screen_num = this.Math.ceil((total_option_num + this.Const.EL_World.EL_WorldChangeEvent.OptionNumPurPage - 1) / this.Const.EL_World.EL_WorldChangeEvent.OptionNumPurPage);
