	...
	EL_Entry = {
		Pool = {
			Entrys = [
				...
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_beast_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_greenskin_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_northerner_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_north_noble_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_southerner_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_south_noble_entry",
					function EL_ifEligible(_item) { return true; }
				},
				{
					Scripts = "scripts/skills/el_entrys/helmet_entrys/el_special_defense_undead_entry",
					function EL_ifEligible(_item) { return true; }
				}
			],
		},
		...
		Factor = {
			...
			EL_SpecialDefenseBeast = {
				ID = "el_helmet_entry.special_defense_beast",
			...
			EL_SpecialDefenseGreenskin = {
				ID = "el_helmet_entry.special_defense_greenskin",
				BaseDamageHeadReduction = 50,
				RandomMinDamageHeadReduction = [
					1,
					1,
			...
			EL_SpecialDefenseNortherner = {
				ID = "el_helmet_entry.special_defense_northerner",
				BaseDamageHeadReduction = 50,
				RandomMinDamageHeadReduction = [
					1,
					1,
			...
			EL_SpecialDefenseNorthNoble = {
				ID = "el_helmet_entry.special_defense_north_noble",
				BaseDamageHeadReduction = 50,
				RandomMinDamageHeadReduction = [
					1,
					1,
			...
			EL_SpecialDefenseSoutherner = {
				ID = "el_helmet_entry.special_defense_southerner",
				BaseDamageHeadReduction = 50,
				RandomMinDamageHeadReduction = [
					1,
					1,
			...
			EL_SpecialDefenseUndead = {
				ID = "el_helmet_entry.special_defense_undead",
				BaseDamageHeadReduction = 50,
				RandomMinDamageHeadReduction = [
					1,
					1,
