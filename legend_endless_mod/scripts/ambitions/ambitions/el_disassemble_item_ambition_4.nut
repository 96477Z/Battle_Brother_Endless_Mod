this.el_disassemble_item_ambition_4 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_AmountNeed = 10000
	},
	function create()
	{
		...
		this.m.ID = "ambition.el_disassemble_item_4";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_disassemble_item_3").isDone())
		{
			return;
		}
