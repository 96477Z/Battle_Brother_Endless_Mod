this.el_armor_ambition_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_RankNeed = this.Const.EL_Item.Type.Premium,
        EL_ConditionMaxNeed = 300
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_armor_1";
		...
		this.m.UIText = "拥有3件200+基础耐久的1阶盔甲和头盔";
		this.m.TooltipText = "拥有3件至少1阶的盔甲和头盔，每件装备都有200或以上的基础耐久。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_armor_0").isDone())
		{
			return;
		}
