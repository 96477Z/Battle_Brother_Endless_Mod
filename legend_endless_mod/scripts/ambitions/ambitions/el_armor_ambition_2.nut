this.el_armor_ambition_2 <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.UIText = "拥有3件200+基础耐久的2阶盔甲和头盔";
		this.m.TooltipText = "拥有3件至少2阶的盔甲和头盔，每件装备都有200或以上的基础耐久。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_armor_1").isDone())
		{
			return;
		}
