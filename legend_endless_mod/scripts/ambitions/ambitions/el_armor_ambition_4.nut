this.el_armor_ambition_4 <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.UIText = "拥有2件300+基础耐久的4阶盔甲和头盔";
		this.m.TooltipText = "拥有2件至少4阶的盔甲和头盔，每件装备都有300或以上的基础耐久。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
	...
	function onCheckSuccess()
	{
		...
		if (armor.Armor >= 2 && armor.Helmet >= 2)
		{
			return true;
		}
