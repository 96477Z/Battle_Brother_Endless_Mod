this.el_armor_ambition_0 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_RankNeed = this.Const.EL_Item.Type.Normal,
        EL_ConditionMaxNeed = 300
	},
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_armor_0";
		...
		this.m.UIText = "拥有3件200+基础耐久的0阶盔甲和头盔";
		this.m.TooltipText = "拥有3件至少0阶的盔甲和头盔，每件装备都有200或以上的基础耐久。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
