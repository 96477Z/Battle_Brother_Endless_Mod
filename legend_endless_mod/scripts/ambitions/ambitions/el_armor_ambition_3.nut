this.el_armor_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.UIText = "拥有3件200+基础耐久的3阶盔甲和头盔";
		this.m.TooltipText = "拥有3件至少3阶的盔甲和头盔，每件装备都有200或以上的基础耐久。 Whether you buy them or loot them off of the battlefield, they will protect your men equally well.";
