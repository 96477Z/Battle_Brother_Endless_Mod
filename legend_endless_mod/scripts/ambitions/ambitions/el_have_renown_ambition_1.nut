this.el_have_renown_ambition_1 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_ReputationNeed = 2000
    },
	function create()
	{
		this.ambition.create();
		this.m.ID = "ambition.el_have_renown_1";
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.make_nobles_aware").isDone() && !this.World.Ambitions.getAmbition("ambition.el_have_renown_0").isDone())
		{
			return;
		}
