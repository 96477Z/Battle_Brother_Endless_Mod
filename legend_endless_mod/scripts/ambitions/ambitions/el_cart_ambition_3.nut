this.el_cart_ambition_3 <- this.inherit("scripts/ambitions/ambition", {
	m = {
        EL_SlotGiven = 50,
        EL_MoneyNeed = 200000,
        EL_MoneyCost = 100000
	...
	{
		if (!this.World.Ambitions.getAmbition("ambition.el_cart_2").isDone())
		{
			return;
		}
