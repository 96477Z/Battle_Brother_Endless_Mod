this.enchanter_building <- this.inherit("scripts/entity/world/camp/camp_building", {
	...
	{
		local desc = "";
		desc = desc + "Tha Vala emporium of mystical (and maybe even magical) mischief. While encamped, the Vala can retreat into her books and experiements. ";
		...
		desc = desc + "Only the Vala can be assigned to the Enchating tent. Vala\'s ability to inscribe runes is determined by learning the correct inscriptions via her perks.";
		desc = desc + "\n\n";
		...
		desc = desc + "Additionally, the upgraded tools and equipment from the cart allows the Vala to produces potentially more powerful Runes.";
		return desc;
	}
