this.healer_building <- this.inherit("scripts/entity/world/camp/camp_building", {
	...
	function getDescription()
	{
		...
		desc = desc + "Assigning brothers to this tent allows them to treat any wounds in the company roster and also help restore healthpoints of any injured brother. ";
		...
		desc = desc + "\n\n";
		desc = desc + "The healing tent can be upgraded by purchasing a crafting cart from a settlement merchant. An upgraded tent has a 33% increase in treatment speed and a 25% decrease in medicine cost for each injury.";
		return desc;
	}
